...
#Documentation for a Cmdlet
Get-Help Get-ChildItem

#find a command by whatever parts you remember (Noun, Verb or Module)
Import-Module WebAdministration #more detail on modules later
Get-Command -Verb Get -Module WebAdministration
